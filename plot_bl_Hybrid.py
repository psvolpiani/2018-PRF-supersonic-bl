...
# Files
cases = [
         "./m228_twtr100_bl/bl_1536x384x128-1-242files",
        ]

# EXP
fileXP = "./EXP/Schlatter2010_Retheta670.txt"
...
for case in cases:
    ...
    elif  (case=="./m228_twtr100_bl/bl_1536x384x128-1-242files"):    # Adi
      muref=0.000122 ; TW=1.920; Tr=TW/1.0; xplot=35.; xsp=60; dz=5./128;
    elif  (case=="./m228_twtr190_bl/case2_1536x288x128-5-600files"): # Hot
      muref=0.000120 ; TW=3.658; Tr=TW/1.9; xplot=35.; xsp=60; dz=5./128;
    elif  (case=="./m228_twtr050_bl/bl1_1800x480x256-1-240files"):   # Cold
      muref=0.000129 ; TW=0.963; Tr=TW/0.5; xplot=35.; xsp=60; dz=5./256;
    elif  (case=="./m228_twtr100_bl_hRe/bl_1800x480x256-1-241files"):# Adi - High Reynolds
    ...
    axes6.scatter(y1[markers1], urmsp1[markers1]**2, color='c', marker='o', facecolors='white', linewidth='1')
    axes6.scatter(y1[markers1], vrmsp1[markers1]**2, color='c', marker='o', facecolors='white', linewidth='1')
    axes6.scatter(y1[markers1], wrmsp1[markers1]**2, color='c', marker='o', facecolors='white', linewidth='1')
    axes6.scatter(y1[markers1], - uvp1[markers1]**2, color='c', marker='o', facecolors='white', linewidth='1')
